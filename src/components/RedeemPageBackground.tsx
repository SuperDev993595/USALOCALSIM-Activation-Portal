...
export function RedeemPageBackground({ children }: { children: ReactNode }) {
  return (
    <div className="public-site public-site--redeem relative isolate flex min-h-screen flex-col">
      <div className="redeem-bg-aurora pointer-events-none absolute inset-0 z-[1]" aria-hidden />
